...
const todayTask1 = createTask.createDatedTask("today 1", "today task 1", "2025-03-16", true, 2);
const todayTask2 = createTask.createDatedTask("today 2", "today task 2", "2025-03-16T13:45:00", false, 3);
const todayTask3 = createTask.createDatedTask("today 3", "today task 3", "2025-03-16T21:22:00", false, 1);
const todayTask4 = createTask.createDatedTask("today 4", "today task 4", "2025-03-16", true, 2);
dated4.complete();
dated5.complete();
todayTask4.complete();
